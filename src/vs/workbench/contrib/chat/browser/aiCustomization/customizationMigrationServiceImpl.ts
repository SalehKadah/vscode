...
import { CustomizationMigration, CustomizationMigrationHintTarget, CustomizationMigrationType, FileCustomizationMigration, FileCustomizationMigrationType, getCustomizationMigrationTargetType, ICustomizationMigrationHint, ICustomizationMigrationService, isPromptFileMigrationCandidate, isUserDataMigrationCandidate, McpServerCustomizationMigration, MigratableConfiguration } from '../../common/promptSyntax/service/customizationMigrationService.js';
...
export class CustomizationMigrationService implements ICustomizationMigrationService {
	...
	async computeMigrationHint(sessionResource: URI, includeCustomizationSummary = false): Promise<ICustomizationMigrationHint | undefined> {
		...
		const [userDataMigration, promptFilesMigration, mcpServerMigration, customizations] = await Promise.all([
			this.computeMigration(sessionResource, CustomizationMigrationType.UserData),
			this.computeMigration(sessionResource, CustomizationMigrationType.PromptFiles),
			this.computeMigration(sessionResource, CustomizationMigrationType.McpServers),
		...
		const fileCandidates = [...userDataMigration.candidates, ...promptFilesMigration.candidates];
